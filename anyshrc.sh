...
alias lnc="GOMA_DISABLED=true anc"
alias lncr="GOMA_DISABLED=true ancr"
alias lncrc="GOMA_DISABLED=true ancrc"
alias lncrt="GOMA_DISABLED=true ancrt"
alias lncrcr="GOMA_DISABLED=true ancrcr"
